...
for load_player_sneak in range(12):
    sneaking_list.append(pygame.image.load("sprites/player/player_sneak_{}.png".format(load_player_sneak+1)))

# Enemy images
enemy_dying_list = []
enemy_gun = pygame.image.load("sprites/player/enemy_gun.png")
